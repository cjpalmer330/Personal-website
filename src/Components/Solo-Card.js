...
export default function SoloCard({ Title, blurb }){
  return(
      <div className="rounded-3xl bg-gray-700 border border-blue-500  shadow-blue-500 p-4 transition-all duration-300 lg:grid lg:grid-rows-5 min-w-[700px] min-h-[200px] lg:m-36 m-8 text-center">
