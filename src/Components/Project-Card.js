...
export default function ProjectCard({ Title, blurb, link }){
  return(
    ...
    to={link}
    >
      <div className="rounded-3xl bg-gray-700 hover:scale-105 border border-blue-500 hover:to-blue-500/50 hover:shadow-blue-600 !shadow-xl shadow-blue-600 p-4 transition-all duration-300 grid grid-rows-5 min-w-[550px] max-h-[750px] min-h-[200px]">
