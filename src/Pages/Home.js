    ...
    <div class="h-screen">
      ...
      <body className="overflow-hidden bg-slate-900 text-white font-mono">
        <div className="p-36 grid grid-rows-3 grid-cols-2 gap-24">
          ...
          <div className="shadow-2xl shadow-slate-500 rounded-xl p-12 bg-slate-700 border border-1">
          ...
          <div className="shadow-2xl shadow-slate-500 bg-slate-700 border border-1 rounded-xl p-12">
            <h3 className='font-mono text-white font-bold text-center text-2xl'>
              Sample Text
            </h3>
            <a
