...
export default function AboutThis(){
  ...
  return (
    <div className="Project h-screen">
      <SocialBar />
      <body className="overflow-hidden h-screen bg-slate-900 text-white font-mono justify-items-center">
        <div className="p-4 border border-blue-400 shadow-2xl shadow-blue-500 bg-slate-700 rounded-3xl mt-36 ml-4 mr-4 min-w-[500px] max-w-[1000px]">
