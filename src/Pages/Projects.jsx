    ...
    <div className="min-h-screen min-w-[900px] bg-gray-900">
      ...
      <div className="overflow-hidden min-h-screen bg-gray-900 text-white font-mono min-w-[500px]">
        ...
        <div  className="grid grid-cols-5 gap-0">
            <div className="rounded-3xl border-blue-500 border bg-gray-700 shadow-xl shadow-blue-600 p-4 transition-all duration-300 grid grid-rows-5 min-w-[550px] max-h-[550px] min-h-[100px] mb-8 mt-12 lg:col-end-5 lg:col-start-3 col-start-1 col-span-5 m-8">
