...
export default function SocialBar(){
  return(
    <div>
      <header className="w-screen text-xl bg-slate-900 overflow-hidden grid grid-rows-2 pr-4">
      <div className="z-40">
      ...
      <nav>
        <div>
          ...
          <li className='inline-block mt-2 mb-2 mr-4 ml-4 w-full'>
            ...
            <li className='inline-block mt-2 mb-2 mr-4 ml-4 w-full'>
              <Link
              className="pt-2 pb-2 pl-4 pr-4 border border-blue-400 rounded-xl bg-transparent hover:bg-slate-700 hover:transition-all duration-200 text-white text-nowrap"
